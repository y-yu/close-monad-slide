...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item<4-> \lstinline|Gen[A]|という型クラスで型\lstinline|A|の
    生成方法を定義する
...
\begin{frame}
  ...
  \lstinputlisting[style=scala, firstline=48, lastline=61]{./src/CloseTestHelper.scala}

  \begin{itemize}
    \item<2-> 今まで作った\lstinline|Gen|を用いて\lstinline|Gen[Close[R, A]]|を定義
    \item<3-> 1:2の割合で例外をスローする\lstinline|Close|と正常な値を返す\lstinline|Close|を生成
  \end{itemize}
\end{frame}
